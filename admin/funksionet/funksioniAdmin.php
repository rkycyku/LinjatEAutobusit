                ...
                while($row = $result->fetch_assoc()) {
                    echo "
                        <tr>
                            ...
                            <td>$row[aksesi]</td>
                            <td>
                                <a class='btn btn-primary btn-sm' href='adminFUN/perditeso.php?id=$row[id]'>Perditeso</a>
                                <a class='btn btn-danger btn-sm' href='adminFUN/largoUser.php?id=$row[id]&aksesi=$row[aksesi]'>Largo</a>
                            </td>
                        </tr>
                    ";
                }
