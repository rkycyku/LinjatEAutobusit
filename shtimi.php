<?php include './funksione/auth_check_admin.php'; ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        ?>
                ...
                <div class="col-sm-9">
                    <div class="form-row">
                        <div class="form-group col col-lg-6">
                            <?php include "./funksione/radioButton/Relacioni.html"; ?>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-9">
                    <div class="form-row">
                        <div class="form-group col col-lg-9">
                            <?php include "./funksione/radioButton/Kompanit.html"; ?>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    <div class="form-row">
                        <div class="form-group col col-lg-6">
                            <input type="text" name="shenimeShtes" class="form-control" id="shenimeShtes "/>
                        </div>
                    </div>
                </div>
            </div>
